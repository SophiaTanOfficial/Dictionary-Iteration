...
for person in favorite_books:
 print(person + "'s favorite book is " + favorite_books[person])
...
for people in address_book.contacts:
  print(people["name"] + " can be reached at " + people["phone"])
...
phone_numbers = []
for people in address_book.contacts:
  phone_numbers.append(people["phone"])
...
edu_emails = []
for people in address_book.contacts:
  if ".edu" in people["email"]:
    edu_emails.append(people["email"])
